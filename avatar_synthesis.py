...
def submit_synthesis(job_id: str):
    ...
    payload = {
        ...
        "inputKind": "SSML",  # PlainText or SSML
        "inputs": [
            {
                "content": "<speak version=\"1.0\" xml:lang=\"ar-SA\"><voice name=\"ar-SA-HamedNeural\">مرحبا, أنا أعربلي, مساعدك الذكي للإعراب</voice></speak>"
            }
        ],
        "avatarConfig": {
              "customized": False, # set to True if you want to use customized avatar
              "talkingAvatarCharacter": 'Harry',  # talking avatar character
